    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
                ...
                <li class="nav-item m-3">
                    <a class="nav-link text-light" aria-current="page" href="{{ route('signuplogin.signup') }}">Register</a>
                </li>
                ...
                <li class="nav-item m-3">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('signuplogin.userlogin') }}">User Login</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.adminlogin') }}">Admin Login</a></li>
                            <li><a class="dropdown-item" href="{{ route('collector.collectorlogin') }}">Collector Login</a></li>
                        </ul>
                    </div>
                </li>
