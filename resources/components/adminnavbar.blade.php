            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5 text-light align-items-center">
                ...
                <li class="nav-item mx-3">
                    <select onchange="window.location.href=this.value"
                        ...
                        <option value="{{ route('collector.collectordetails') }}" class="bg-light text-dark">Collector</option>
                    </select>
                </li>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content bg-light text-dark">
      <div class="modal-header">
        <h5 class="modal-title" id="registerCollectorModalLabel">Register Collector</h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" id="coll_fname" name="coll_fname" class="form-control border border-success text-dark" placeholder="Enter first name">
            </div>

            <!-- Lastname -->
            <div class="col-md-6 mb-3">
              <label for="coll_lname" class="form-label">Lastname</label>
              <input type="text" id="coll_lname" name="coll_lname" class="form-control border border-success text-dark" placeholder="Enter last name">
            </div>

            <!-- Cellphone -->
            <div class="col-md-6 mb-3">
              <label for="collcell_num" class="form-label">Cellphone Number</label>
              <input type="number" id="collcell_num" name="collcell_num" class="form-control border border-success text-dark" placeholder="Enter cellphone number">
            </div>

            <!-- Username -->
            <div class="col-md-6 mb-3">
              <label for="username" class="form-label">Username</label>
              <input type="text" id="username" name="username" class="form-control border border-success text-dark" placeholder="Enter username">
            </div>
            ...
            <div class="col-12 mb-3">
              ...
              <div class="position-relative">
                <input type="password" id="password" name="password" class="form-control border border-success text-dark pe-5" placeholder="Enter password">
