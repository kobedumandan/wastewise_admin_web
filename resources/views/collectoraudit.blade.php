...
@section('content')
    <div class="container">
                ...
                <div class="card h-100" style="border-radius: 14px; position: relative; overflow: hidden; background-image: url('{{ asset('backgrounds/user_icon.png') }}'); background-size: contain; background-position: center left; background-repeat: no-repeat;">
                    <div class="card-body d-flex align-items-center justify-content-end" style="position: relative; z-index: 2;">
                        <div class="card-content" style="position: relative; z-index: 2;">
                            <p class="card-title" style="color: #333; font-weight: 400; font-size: 15px; height: 4px;">Total Collector Audits</p>
        ...
        <table class="table caption-top">
            <caption>List of Collector Audit Records</caption>
            <thead>
                <tr>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Collector First Name</label>
                                            <p class="form-control-plaintext">{{ $audit->collector_firstname ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Collector Last Name</label>
                                            <p class="form-control-plaintext">{{ $audit->collector_lastname ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Collector UID</label>
                                            <p class="form-control-plaintext">{{ $audit->collector_uid ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">User UID</label>
                                            <p class="form-control-plaintext">{{ $audit->user_uid ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-md-6">
            ...
            <tfoot id="empty-message" style="display: none;">
                <tr>
                    <td colspan="5" class="text-center">No audit records found matching your search</td>
                </tr>
            </tfoot>
        </table>
